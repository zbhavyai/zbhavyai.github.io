...
\begin{tabular}{ l l }
    ...
    \textbf{Frontend}   & TypeScript, JavaScript, React.js, Bootstrap, HTML, CSS                                \\
    \textbf{Databases}  & SQL, PostgreSQL, MySQL, Flyway                                                        \\
    \textbf{Tools}      & Docker, Git, Linux, Ansible, Bash, Maven, Postman, Grafana, Prometheus, Nginx, CI/CD  \\
