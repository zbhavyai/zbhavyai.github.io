...
\begin{itemize} \itemsep 2pt
    \resumeItemExperience {Currently developing edge-based \textbf{AI Agent creation framework} using \textbf{Ollama and LangChain4J} to enable customers automate \textbf{anomaly detection and incident reporting}.}
